class Wheel {
  ...
  spin() {
    ...
    //   console.log('bankrupt spin', this.currentSpin)
    //   domUpdates.updateSpinValueOnDom(0); 
    // } else if(this.currentSpin === 'LOSE A TURN') {
    //   console.log('loose a turn spin', this.currentSpin)
    // } else { 
    //   console.log('this is your spin', this.currentSpin)
    // } 
  };
};
