class Game {
  ...
  updateCurrentPlayer() {
    ...
    domUpdates.updateCurrentPlayer(this.players[this.currentPlayer].playerName);
  ...
  startNewRound() {
    ...
    domUpdates.updateRound(this.currentRound + 1);
    domUpdates.updatePlayerInfo(this.players);
    domUpdates.addPlayerTurnClass(this.currentPlayer);
